    ...
    return (
        <div className="page">
            ...
            <main className="page-contents">
                <div id="top-bar">
                    <Search setResults={setResults} keyword={keyword} setKeyword={setKeyword} setPopularLoaded={setPopularLoaded} prevKeyword={prevKeyword} setPrevKeyword={setPrevKeyword} />
                    <img
